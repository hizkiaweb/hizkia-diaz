  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-background flex items-center justify-center">
      ...
      >
        ...
        <div className="w-full max-w-[1600px] h-[85vh] md:h-[65vh] transform -translate-y-[30vh] -translate-x-[20%] scale-[1.2] md:translate-y-0 md:translate-x-0 md:scale-100 transition-transform duration-500">
          <motion.img 
