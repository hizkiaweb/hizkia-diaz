  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-background flex items-center justify-center">
      ...
      <motion.div 
        ...
        className="absolute inset-0 z-20 w-full h-full pointer-events-none flex justify-center items-center md:-translate-y-[5vh] -translate-x-[35%]" 
      >
        {/* PERBAIKAN MOBILE: Ditarik naik jauh (-translate-y-[15vh]), geser kiri 15%, scale 1.2 */}
        <div className="w-full max-w-[1600px] h-[85vh] md:h-[65vh] transform -translate-y-[30vh] -translate-x-[14%] scale-[1.2] md:translate-y-0 md:translate-x-0 md:scale-100 transition-transform duration-500">
          <motion.img 
